...
import Style from './Question_bank.module.css'
...
<span className='pe-1'>اضافة بنك</span> 
<i class="fa-solid fa-file-circle-question fa-sm"></i>  
  </button>
</div>
{/* </div>
          ...
          <thead>
            <tr className="bg-white ">
              ...
              <div className="grid grid-cols-4 auto-cols-max justify-stretch 	 ">
                ...
                <div className="ps-6 " >عنوان بنك الأسئلة</div>
                </th>
